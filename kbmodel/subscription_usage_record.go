		...
		if m.UnitUsageRecords[i] != nil {
			if err := m.UnitUsageRecords[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("unitUsageRecords" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *SubscriptionUsageRecord) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateUnitUsageRecords(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *SubscriptionUsageRecord) contextValidateUnitUsageRecords(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.UnitUsageRecords); i++ {

		if m.UnitUsageRecords[i] != nil {
			if err := m.UnitUsageRecords[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("unitUsageRecords" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("unitUsageRecords" + "." + strconv.Itoa(i))
