...
func (o *CreateSubscriptionWithAddOnsParams) SetDefaults() {
	...
	val := CreateSubscriptionWithAddOnsParams{
...
// bindParamCreateSubscriptionWithAddOns binds the parameter pluginProperty
func (o *CreateSubscriptionWithAddOnsParams) bindParamPluginProperty(formats strfmt.Registry) []string {
