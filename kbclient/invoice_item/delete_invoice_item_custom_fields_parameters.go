...
// bindParamDeleteInvoiceItemCustomFields binds the parameter customField
func (o *DeleteInvoiceItemCustomFieldsParams) bindParamCustomField(formats strfmt.Registry) []string {
