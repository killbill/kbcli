...
func (o *VoidPaymentByExternalKeyParams) WithDefaults() *VoidPaymentByExternalKeyParams {
	o.SetDefaults()
	return o
}
...
// bindParamVoidPaymentByExternalKey binds the parameter controlPluginName
func (o *VoidPaymentByExternalKeyParams) bindParamControlPluginName(formats strfmt.Registry) []string {
...
// bindParamVoidPaymentByExternalKey binds the parameter pluginProperty
func (o *VoidPaymentByExternalKeyParams) bindParamPluginProperty(formats strfmt.Registry) []string {
